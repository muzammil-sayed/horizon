...
variable "databrewprod_zone_1" {
  description = "First Route53 zone for databrewprod"
}

variable "enable_databrewprod_zone_1" {
  description = "Enable management of the databrewprod_zone_1 route53 zone"
}
